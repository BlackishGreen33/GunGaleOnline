...
class MainMenuScene(MenuScene):
    def __init__(self):
        ...
        self.host_image = pygame.image.load('src/data/sprites/icons/menu_button_host.png')
        self.join_image = pygame.image.load('src/data/sprites/icons/menu_button_join.png')
        self.settings_image = pygame.image.load('src/data/sprites/icons/menu_button_settings.png')
    ...
    def handle_menu_actions(self):
        if self.menu.get_pressed('host'):
            ...
            if not any([self.name_empty, self.name_long, self.teams_less, self.teams_many, self.team_not_in_teams, self.team_same]):
                self.next_scene = HostScene(self.port, 'src/data/maps/map_1.csv', name, teams, own_team)
