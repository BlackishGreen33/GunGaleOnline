...
class Hud:
    def __init__(self, p: Player):
        ...
        self.bullet_images = [
            ...
            pygame.image.load('src/data/sprites/icons/bullet_empty.png').convert_alpha()
        ]
        ...
        self.border_20x20 = pygame.image.load('src/data/sprites/icons/border_20x20.png').convert_alpha()
        self.border_36x20 = pygame.image.load('src/data/sprites/icons/border_36x20.png').convert_alpha()
